          ...
          <div class="card">
            ...
            <div class="card-body">
                ...
                <script type="text/javascript">
                    ...
                    +    '<input class="reformulado" name="cpf_cnpj" id="cpf_cnpj_field" type="text" placeholder="" value="">'
                ...
                <label for="email">E-Mail: </label>
                        <span id="email1" class="textfieldHintState">
                            <input type="text" class="iEmail" name="email" id="email" placeholder="exemplo@meudominio.com" value="" /><br>
