    ...
    <body>
        <?php
            ...
            if(!empty($_POST))
            {
                ...
                if ($tipo == "cliente") {
                    $enderecoControle->inserirEnderecoCliente($id, $endereco);
                    header("Location: ../cliente/detail_cliente.php?id=".$id);
                } else if ($tipo == "empresa") {
                    $enderecoControle->inserirEnderecoEmpresa($id, $endereco);
                    header("Location: ../empresa/detail_empresa.php?id=".$id);
                }
            }
        ...
        <div class="container">
            ...
            <form class="form-horizontal" action="create_endereco.php" method="post">
                ...
                <div class="form-actions">
                    ...
                    if($tipo=="cliente") {
                        echo '<a href="../Cliente/detail_cliente.php?id='.$id.'" type="btn" class="btn btn-default">Voltar</a>';
                    } else if($tipo=="empresa") {
                        echo '<a href="../Empresa/detail_empresa.php?id='.$id.'" type="btn" class="btn btn-default">Voltar</a>';
                    } 
